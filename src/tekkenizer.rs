...
impl Tekkenizer {
    ...
    pub fn from_file<P: AsRef<Path>>(path: P) -> Result<Self> {
        ...
        if model_data.special_tokens.is_none() && version.requires_explicit_special_tokens() {
            return Err(TokenizerError::InvalidConfig(format!(
        ...
        let special_tokens = model_data
            .special_tokens
            .unwrap_or_else(get_deprecated_special_tokens);
